...
Fork of re3/reVC with physics fixes for high framerates. Vehicle wheel spin, grip, boat controls, and collision forces are now scaled by a delta-time tick system (`CTimer::GetTimeStepFix`), keeping behavior consistent above 30 FPS without affecting low-framerate gameplay.
